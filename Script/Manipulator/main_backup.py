...
def get_user_input():
    initial_coords = input("Enter initial coordinates (x, y) separated by a comma: ")
    target_coords = input("Enter target coordinates (x, y) separated by a comma: ")
...
def main():
    ...
    #initial_coords, target_coords = get_user_input()
    axis_wr = [[-180.0, 180.0],[-160.0, 160.0]]
